...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBadCredentials(BadCredentialsException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(
                buildError("error", "Invalid username or password", request.getRequestURI(), HttpStatus.UNAUTHORIZED));
    }
    ...
    public ResponseEntity<ErrorResponse> handleAccountStatus(AccountStatusException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
                buildError("error", "Account is locked or disabled", request.getRequestURI(), HttpStatus.FORBIDDEN));
    }
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(AccessDeniedException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
                buildError("error", "You are not authorized to access this resource", request.getRequestURI(),
    ...
    public ResponseEntity<ErrorResponse> handleJwtSignature(SignatureException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
                buildError("error", "Invalid JWT signature", request.getRequestURI(), HttpStatus.FORBIDDEN));
    }
